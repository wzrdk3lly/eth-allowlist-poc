...
contract Allowlist is IAllowlist, Ownable {
    ...
    function setImplementations(
        Implementation[] memory implementations
    ) public onlyOwner {
        for (
            ...
            Implementation memory implementation = implementations[
                implementationIdx
            ];
    ...
    function _addCondition(Condition memory condition) internal {
        ...
        bool idHasSpaces = Strings.indexOfStringInString(" ", condition.id) !=
            -1;
     ...
     * @param condition The condition to add
     */
    function addConditionWithoutValidation(
     ...
     * @param _conditions The conditions to add
     */
    function addConditionsWithoutValidation(
    ...
    function conditionsList() public view returns (Condition[] memory) {
        ...
        for (
            ...
            _conditions[conditionIdx] = conditionById[
                conditionsIds[conditionIdx]
            ];
        }
        return _conditions;
    }
    ...
    function conditionsJson() public view returns (string memory) {
        ...
        for (
            ...
            for (
                ...
                writer = writer.writeStringValue(
                    condition.paramTypes[paramTypeIdx]
                );
            }
            ...
            for (
                ...
                string[] memory requirement = condition.requirements[
                    requirementIdx
                ];
                writer = writer.writeStartArray();
                for (
                    ...
                    writer = writer.writeStringValue(
                        requirement[requirementItemIdx]
                    );
                }
                writer = writer.writeEndArray();
            }
